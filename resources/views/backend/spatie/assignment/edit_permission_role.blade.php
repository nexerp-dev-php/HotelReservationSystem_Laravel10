  ...
  crossorigin="anonymous"></script>
			...
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edit Role Permission Assignment</div>
					<div class="ps-3">
					</div>
				</div>
				<!--end breadcrumb-->
				<div class="container">
					<div class="main-body">
						<div class="row">
							<div class="col-lg-12">
								<div class="card">
									<form id="myForm" action="{{ route('permission.role.update.store') }}" method="post">
										@csrf
										<div class="card-body">
											<div class="row mb-3">
												<div class="col-sm-3">
													...
													<div class="form-group col-sm-12 text-secondary">
                                                        @php
                                                            ...
                                                            foreach($assigned_permissions as $assigned_permission) {
                                                                if($assigned_permission->permission_id == $permission->id) {
                                                                    $isAssigned = true;
                                                                    break;
                                                                }
                                                            }
                                                        @endphp                                                        
														<input class="form-check-input mb-3" type="checkbox" name="permission[]" value="{{ $permission->id }}" id="permission{{ $permission->id }}" {{ $isAssigned ? 'checked' : '' }}>
